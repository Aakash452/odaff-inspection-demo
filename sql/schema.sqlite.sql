-- SQLite mirror of schema.mssql.sql so the demo runs with zero setup.
-- Column names and constraints match the SQL Server schema 1:1.
CREATE TABLE IF NOT EXISTS Inspections (
    ...
    InspectorSignature  BLOB,
    FirmRepSignature    BLOB,
